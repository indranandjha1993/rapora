...
DATABASE_URL="postgresql://postgres:password@localhost:5432/rapora?schema=public"
...
- **Super Admin**: Platform-wide access (requires @rapora.app email)
...
Rapora is open source software [licensed as MIT](LICENSE).
