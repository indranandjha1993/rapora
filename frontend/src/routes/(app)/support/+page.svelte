...
<svelte:head>
  <title>Support - Rapora</title>
</svelte:head>

<PageHeader
  title="Help & Support"
  subtitle="Join thousands of businesses using Rapora to manage customer relationships without the enterprise price tag."
  size="display"
/>
  ...
  <section class="content-area">
    <div class="mission-card glass-card animate-in-up stagger-3">
      ...
      <div class="mission-content">
        <h2>Our Mission</h2>
        <p>
          Rapora addresses the high subscription costs of commercial CRM alternatives by
          providing a
    ...
    <div class="bento-grid">
      ...
      <article class="bento-card bento-featured hover-lift animate-in-up stagger-4">
        ...
        <Button
          class="card-action"
          onclick={() => window.open('https://github.com/indranandjha1993/rapora', '_blank')}
        >
      ...
      <article class="bento-card hover-lift animate-in-up stagger-5">
        ...
        <Button
          ...
          onclick={() => (window.location.href = 'mailto:indranandjha0@gmail.com')}
        >
          <Mail class="h-4 w-4" />
          Contact Team
        </Button>
      ...
      <article class="bento-card hover-lift animate-in-up stagger-5">
        ...
        <p>Have an idea? Share your requests and help shape the future of Rapora.</p>
        <Button
          variant="outline"
          class="card-action-outline"
          onclick={() =>
            window.open(
              'https://github.com/indranandjha1993/rapora/issues/new?template=feature_request.md',
              '_blank'
            )}
        >
      ...
      <article class="bento-card hover-lift animate-in-up stagger-6">
        ...
        <Button
          ...
          onclick={() =>
            window.open(
              'https://github.com/indranandjha1993/rapora/issues/new?template=bug_report.md',
              '_blank'
            )}
        >
          <Bug class="h-4 w-4" />
        ...
        <Button
          ...
          onclick={() =>
            (window.location.href =
              'mailto:indranandjha0@gmail.com?subject=Security%20Issue%20-%20Rapora')}
        >
    ...
    <div class="custom-dev-banner animate-in-up stagger-6">
      <div class="banner-content">
        ...
        <Button
          ...
          onclick={() =>
            (window.location.href =
              'mailto:indranandjha0@gmail.com?subject=Custom%20CRM%20Development%20Inquiry')}
        >
