...
<svelte:head>
  <title>Select Organization | Rapora</title>
</svelte:head>
  ...
  <header class="border-b border-[var(--border-default)] bg-[var(--surface-default)]">
    <div class="mx-auto flex max-w-5xl items-center justify-between px-6 py-4">
      <div class="flex items-center gap-3">
        <img src={imgLogo} alt="Rapora" class="h-8 w-auto" />
        <span class="text-lg font-semibold text-[var(--text-primary)]">Rapora</span>
      </div>
      <a
        href="/logout"
    ...
    <div class="w-full max-w-2xl">
      ...
      {:else}
        ...
        >
          ...
          <p class="mt-2 text-[var(--text-secondary)]">
            Create your first organization to get started with Rapora
          </p>
          <a
            href="/org/new"
