# Rapora Backend - Django REST API

The backend for Rapora, a multi-tenant CRM platform built with Django REST Framework.
...
# Email
DEFAULT_FROM_EMAIL=noreply@rapora.com
ADMIN_EMAIL=admin@rapora.com
...
CREATE DATABASE rapora WITH OWNER = postgres;
...
- **Super Admin**: Users with @rapora.app email domain have platform-wide access
...
-- Grant permissions
GRANT CONNECT ON DATABASE rapora TO crm_app;
