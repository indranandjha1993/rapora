...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            "--email",
            type=str,
            default="indranandjha0@gmail.com",
            help="Admin user email (default: indranandjha0@gmail.com)",
        )
    ...
    def create_org(self, currency, country, index=0):
        """Get or create an organization. The first org is always 'Rapora' so
        ...
        """
        name = "Rapora" if index == 0 else self._demo_company()
